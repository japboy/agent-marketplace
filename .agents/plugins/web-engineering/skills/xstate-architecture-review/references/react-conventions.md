...
> **Note:** Machine file naming (`*.machine.ts`) is defined in
> [XState Conventions](./xstate-conventions.md#file-naming-conventions).
...
Match the actor lifecycle to the component's mount/unmount lifecycle. Use `useActor` directly
instead of ActorContext.
